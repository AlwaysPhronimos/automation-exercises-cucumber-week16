...
public class RegisterSteps {
    ...
    public void iShouldSeeTheText(String text, String name) {
        ...
        public void iClickOnMenu(String signUp) {
    ...
    public void iShouldSeeTheLoginPageTitle(String expectedText) {
        Assert.assertEquals(new LoginPage().getTextFromLoginPage(expectedText), "Login to your account");
    }

    @And("I enter email {string} and password {string} field")
    public void iEnterEmailAndPasswordField(String email, String password) {
        new LoginPage().sendDataToLoginFields(email, password);
    }

    @Then("I should see the text {string}")
    public void iShouldSeeTheText(String loginText) {
        Assert.assertEquals(new LoginPage().getTextFromLoginPage(loginText), "Logged in as Smart");
    }
}
